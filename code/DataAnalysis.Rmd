...
vout1 <- voom(counts = counts, lib.size = apply(counts, 2, quantile, .75))


p1 <- pcaplot(dataset = vout1$E, title.name = "Upper Quantile")
p1 
ggplotly()
...
```{r}
AllCov0 <- cbind(FixCov, covset["RIN"])
